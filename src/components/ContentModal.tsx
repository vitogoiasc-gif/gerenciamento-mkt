...
const ContentModal: React.FC<ContentModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.title || !formData.publishDate) {
      toast.error('Preencha título e data de publicação.');
      return;
    }
    setIsSaving(true);
    const payload = {
    ...
    try {
      if (isEditing && contentToEdit) {
        ...
        updateContent({ ...contentToEdit, ...formData, id: data.id,
        ...
        addContent({ ...formData, id: data.id || uuidv4(),
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/60 backdrop-blur-sm p-0 sm:p-4">
      <div className="flex w-full max-w-2xl flex-col bg-white dark:bg-[#131c35] sm:rounded-2xl shadow-2xl overflow-hidden"
        ...
        <form onSubmit={handleSubmit} className="custom-scrollbar flex-1 overflow-y-auto">
                        ...
                        <div className="flex h-full w-full max-w-7xl flex-col items-center justify-center gap-6 lg:flex-row">
                          ...
                          <div className="flex max-h-[400px] w-full flex-col rounded-2xl bg-white dark:bg-[#131c35] shadow-2xl lg:w-80 lg:max-h-full overflow-hidden">
                            ...
                            <div className="flex-1 overflow-y-auto p-4 space-y-3">
                              <textarea className="h-48 w-full resize-none rounded-xl border border-gray-200 dark:border-[#2a3a5c] p-3 text-sm focus:border-brand-primary focus:ring-2 focus:ring-brand-primary/20 dark:bg-[#1a2540] dark:text-[#eaecf8] outline-none lg:h-64"
          ...
          <div className="px-6 pt-5 pb-6 space-y-5">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <div className="relative">
                  <select className={field + ' appearance-none pr-8 cursor-pointer'}
              ...
              <div>
                ...
                <input type="text" placeholder="Post, Reels, Stories..."
                  className={field}
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <FieldLabel icon={<CalendarDays size={12} />}>Data de publicação</FieldLabel>
            ...
            <div>
              ...
              {editingBriefing || !formData.briefing ? (
                <textarea rows={5} autoFocus={editingBriefing}
                ...
                <div onClick={() => setEditingBriefing(true)} title="Clique para editar"
            ...
            <div className="rounded-xl border border-gray-100 dark:border-[#1e2d4f] bg-gray-50/50 dark:bg-[#1a2540]/30 p-4 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <div className="relative">
                    <div className="pointer-events-none absolute inset-y-0 left-3 flex items-center"><Video size={13} className="text-gray-400 dark:text-[#505880]" /></div>
                    <input type="url" placeholder="Cole o link do OneDrive"
              ...
              <div>
                ...
                <div className="relative">
                  <div className="pointer-events-none absolute inset-y-0 left-3 flex items-center"><LinkIcon size={13} className="text-gray-400 dark:text-[#505880]" /></div>
                  <input type="url" placeholder="https://..."
                    className={`${field} pl-8 ${formData.externalLink ? 'pr-10' : ''}`}
                    value={formData.externalLink || ''}
                    onChange={e => setFormData({ ...formData, externalLink: e.target.value })} />
                  {formData.externalLink && (
                    <a href={formData.externalLink.startsWith('http') ? formData.externalLink : `https://${formData.externalLink}`}
                      target="_blank" rel="noopener noreferrer" onClick={e => e.stopPropagation()}
                      className="absolute inset-y-0 right-3 flex items-center text-brand-primary hover:text-brand-secondary transition-colors" title="Abrir link">
            ...
            <div className="rounded-xl border border-amber-200 dark:border-amber-800/40 bg-amber-50/60 dark:bg-amber-900/10 p-4">
              ...
              <textarea rows={formData.managerComments ? 2 : 3}
