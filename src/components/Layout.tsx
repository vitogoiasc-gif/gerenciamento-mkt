  ...
  return (
    <div className="flex h-screen bg-bg-light dark:bg-bg-dark text-gray-900 dark:text-gray-100 font-sans transition-colors duration-300">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        {/* CONTEÚDO */}
        <div id="main-scroll" className="flex-1 overflow-y-auto bg-[#F8F8FC] dark:bg-bg-dark">

          <div className="flex flex-col min-h-full p-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
