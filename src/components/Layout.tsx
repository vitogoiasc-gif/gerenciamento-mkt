...
const Layout: React.FC = () => {
  ...
  return (
    <div className="flex h-screen bg-bg-light dark:bg-bg-dark text-gray-900 dark:text-[#eaecf8] font-sans transition-colors duration-300">
      ...
      <aside className={`${isSidebarCollapsed ? 'w-20' : 'w-64'} bg-white dark:bg-[#131c35] border-r border-gray-100 dark:border-[#1e2d4f] flex flex-col transition-all duration-300 overflow-hidden`}>
        ...
        <div className="p-4 flex items-center justify-center h-[72px]">
          <button
            ...
            className="p-2 rounded-lg text-gray-500 hover:bg-gray-100 dark:hover:bg-[#1e2d4f] dark:text-[#7078a8] transition-colors"
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `flex items-center ${isSidebarCollapsed ? 'justify-center' : 'gap-3'} px-3 py-2 rounded-lg transition-colors whitespace-nowrap ${isActive
                  ...
                  : 'text-gray-600 dark:text-[#7078a8] hover:bg-gray-100 dark:hover:bg-[#1e2d4f] hover:text-gray-900 dark:hover:text-[#eaecf8]'
                }`
              }
            >
              {item.icon}
        ...
        {/* BOTÃO ONEDRIVE */}
        <div className="p-4 border-t border-gray-200 dark:border-[#1e2d4f] flex justify-center">
          <a
            ...
            className="flex items-center gap-2 text-gray-600 dark:text-[#7078a8] hover:text-blue-600 transition-colors"
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="relative" ref={notificationRef}>
              <button
                ...
                className={`relative p-2 rounded-full transition-all ${isNotificationsOpen
                    ...
                    : 'text-gray-500 hover:bg-gray-100 dark:hover:bg-[#1e2d4f] dark:text-[#7078a8]'
                  }`}
              >
                <Bell size={22} />

                {contentsWithFeedback.length > 0 && (
                  <span className="absolute top-1 right-1 w-5 h-5 bg-red-500 text-white text-[10px] font-bold flex items-center justify-center rounded-full border-2 border-white dark:border-[#0f1629] animate-pulse">
                  ...
                  <div className="max-h-96 overflow-y-auto">
                    {contentsWithFeedback.map(content => (
                      <button
                        ...
                        className="w-full p-4 text-left hover:bg-gray-50 dark:hover:bg-[#1e2d4f] flex gap-3"
                      >
        ...
        {/* CONTEÚDO */}
        <div className="flex-1 overflow-y-auto p-8 bg-[#F8F8FC] dark:bg-bg-dark flex flex-col">
          ...
          {/* FOOTER */}
          <footer className="mt-10 text-center text-sm text-gray-500 dark:text-[#7078a8] border-t pt-6">
